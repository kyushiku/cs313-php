...
News:<input type="radio" name="categories_id" value ="1"><br>
Troubleshooting:<input type="radio" name="categories_id" value ="2"><br>
Content:<textarea name="desc_text" placeholder="Content"></textarea>
